...
class BestProductCVC: UICollectionViewCell {
    ...
    func configureCellBestProduct(withBannerData dictData : Dictionary<String,Any> , andIndxPath indxPath : IndexPath)
    {
        ...
        if special_price == "0.0000"
        {
            ...
            self.lblPriceLine.text = "\(symbol)\(specialPriceFlt)"
