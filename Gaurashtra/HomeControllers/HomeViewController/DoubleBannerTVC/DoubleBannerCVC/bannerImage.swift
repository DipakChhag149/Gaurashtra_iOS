...
class DoubleBannerCVC: UICollectionViewCell {
    ...
    func configureDoubleBannerCell(withBannerData dictData : Dictionary<String,Any> , andIndxPath indxPath : IndexPath)
    {
