...
class RecommendedProductCVC: UICollectionViewCell {
    ...
    func getDevice()
    {
        if UIDevice().userInterfaceIdiom == .phone {
            ...
            case 1136://iphone 5/5S/SE
                ...
                self.lblPerc.font = UIFont(name: "System-Regular", size: 10)
                
                self.lblSpecialPrice.font = UIFont(name: "System-Regular", size: 10)
            ...
            case 1334://iphone 6/6S/7/8
                ...
                self.lblPerc.font = UIFont(name: "System-Regular", size: 14)
            ...
            case 2208://iphone 6+/6S+/7+/8+
                ...
                self.lblPerc.font = UIFont(name: "System-Regular", size: 15)
    ...
    func configureCellrecommendedProduct(withBannerData dictData : Dictionary<String,Any> , andIndxPath indxPath : IndexPath)
    {
        print(dictData)
        ...
        //let specialFloat = Double(round(100*specialPrice)/100) +
